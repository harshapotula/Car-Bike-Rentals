...
public class dsbmw extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dsbmw);
        initFromDatePicker();
        initToDatePicker();

        frombutton = findViewById(R.id.bmwfromdatebutton);
        frombutton.setText(getTodayDate1());
        tobutton = findViewById(R.id.bmwtodatebutton);
        frombutton.setText(getTodayDate2());

        cbookingbtn = findViewById(R.id.bmwcontinuebooking);
        cbookingbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(),bmwfinal.class);
