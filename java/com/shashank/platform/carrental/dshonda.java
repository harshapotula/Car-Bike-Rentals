...
public class dshonda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dshonda);

        initFromDatePicker();
        initToDatePicker();

        frombutton = findViewById(R.id.hondafromdatebutton);
        frombutton.setText(getTodayDate1());
        tobutton = findViewById(R.id.hondatodatebutton);
        frombutton.setText(getTodayDate2());

        cbookingbtn = findViewById(R.id.hondacontinuebooking);
        cbookingbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(),hondafinal.class);
