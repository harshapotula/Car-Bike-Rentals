...
public class dsbenz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dsbenz);

        initFromDatePicker();
        initToDatePicker();

        frombutton = findViewById(R.id.benzfromdatebutton);
        frombutton.setText(getTodayDate1());
        tobutton = findViewById(R.id.benztodatebutton);
        frombutton.setText(getTodayDate2());

        cbookingbtn = findViewById(R.id.benzcontinuebooking);
        cbookingbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(),benzfinal.class);
