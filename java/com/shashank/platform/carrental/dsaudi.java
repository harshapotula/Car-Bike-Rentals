...
public class dsaudi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dsaudi);
        initFromDatePicker();
        initToDatePicker();

        frombutton = findViewById(R.id.audifromdatebutton);
        frombutton.setText(getTodayDate1());
        tobutton = findViewById(R.id.auditodatebutton);
        frombutton.setText(getTodayDate2());

        cbookingbtn = findViewById(R.id.audicontinuebooking);
        ...
        cbookingbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               Intent intent = new Intent(getApplicationContext(),audifinal.class);
