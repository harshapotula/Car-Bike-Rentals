...
public class dsducati extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dsducati);
        initFromDatePicker();
        initToDatePicker();

        frombutton = findViewById(R.id.ducatifromdatebutton);
        frombutton.setText(getTodayDate1());
        tobutton = findViewById(R.id.ducatitodatebutton);
        frombutton.setText(getTodayDate2());

        cbookingbtn = findViewById(R.id.ducaticontinuebooking);
        cbookingbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(),ducatifinal.class);
